...
functionality of :term:`pyOpenMS` to quickly create fully interactive views of
:term:`mass spectrometry` data. Here we plot a full map of :term:`MS1` that can be
