...
.. glossary::
    ...
    TOPP tools
        OpenMS provides a number of functions that process :term:`mass spectrometry<Mass spectrometry>` data called TOPP tools. All TOPP tools are described in the `OpenMS API reference documentation <https://abibuilder.cs.uni-tuebingen.de/archive/openms/Documentation/nightly/html/TOPP_documentation.html>`_.
