...
.. glossary::
    ...
    MS2
        Tandem mass spectrometry, also MS/MS, a technique where two or more mass analyzers are coupled together.
        The ions from MS1 spectra are selectively fragmented and analyzed by a second stage of mass spectrometry.
    ...
    MSExperiment
        An OpenMS class (:py:class:`~.MSExperiment`) used to represent a single mass spectrometry run. `Read the documentation for further information <https://abibuilder.cs.uni-tuebingen.de/archive/openms/Documentation/nightly/html/classOpenMS_1_1MSExperiment.html>`_.
