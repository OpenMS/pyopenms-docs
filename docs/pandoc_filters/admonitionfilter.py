...
admonition_colors = {"attention": "#FFA07A", "caution": "#FFA07A", "danger": "#CD5C5C", "error": "#CD5C5C", "hint": "#F0F8FF", "important": "#FFA500", "note": "#BDE5F8", "tip": "#F0E68C", "warning": "#FFA07A", "goal": "#98FB98"}
admonition_icons = {"attention": "fas fa-exclamation", "caution": "fas fa-exclamation-triangle", "danger": "fas fa-exclamation-triangle", "error": "fas fa-bomb", "hint": "far fa-lightbulb", "important": "fas fa-exclamation", "note": "far fa-sticky-note", "tip": "far fa-lightbulb", "warning": "fas fa-exclamation-triangle", "goal": "far fa-check-square"}
            ...
            if "admonition" not in classes:
                ...
                for subtype in admonition_subtypes:
                  if subtype in header.lower():
                    ...
                    break
            newcontents = [html('<div style="background-color: ' + admonition_colors[admonition_subtype] + '; margin: 10px 0px; padding:12px;"><p style="font-size: x-large"><i class="' + admonition_icons[admonition_subtype] + '"></i> <b>' + header + '</b></p>')] + contents[1:] + [html('</div>')]
